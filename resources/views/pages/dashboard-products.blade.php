                ...
                <div class="row mt-4">
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    ...
                    >
                      <div class="card-body">
                        <img
                          src="/images/products-card-2.png"
                          alt=""
                          class="w-100 mb-2"
                        />
                        <div class="product-title">Air Jordan</div>
                    ...
                    >
                      <div class="card-body">
                        <img
                          ...
                          class="w-100 mb-2"
                        />
                        <div class="product-title">Machiato Caramel</div>
                        <div class="product-category">Foods</div>
                      </div>
                    </a>
                  </div>
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    ...
                    >
                      <div class="card-body">
                        <img
                          src="/images/products-card-3.png"
                          alt=""
                          class="w-100 mb-2"
                        />
                        <div class="product-title">IKEA SOffa</div>
                    ...
                    >
                      <div class="card-body">
                        <img
                          ...
                          class="w-100 mb-2"
                        />
                        <div class="product-title">Soffa Lembut</div>
                        <div class="product-category">Furniture</div>
                      </div>
                    </a>
                  </div>
